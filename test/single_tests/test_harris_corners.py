...
def compare_images(img1_path, img2_path, threshold=70):
    """
...
def main():
    # Define paths
    output_path = "apps/feature-detection/output_images/harris_sharp_input_image.png"
    expected_path = "apps/feature-detection/output_images/expected_harris_sharp_input_image.png"
