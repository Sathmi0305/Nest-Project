...
def compare_images(img1_path, img2_path, threshold=100):
    """
...
def main():
    # Define paths
    output_path = "apps/feature-detection/output_images/canny_edges.png"
    expected_path = "apps/feature-detection/output_images/expected_canny_edges.png"
