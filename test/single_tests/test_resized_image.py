...
def compare_images(img1_path, img2_path, threshold=110):
    """
...
def main():
    # Define paths
    output_path = "apps/basic-processing/output_images/resized_image.png"
    expected_path = "apps/basic-processing/output_images/expected_resized_image.png"
